...
public class MainActivity extends CommonMethods implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private boolean isLiteModeEnabled = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isLiteModeEnabled = appSettings.getBoolean("LiteModeEnabled", false);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        navigationView.getMenu().findItem(R.id.navbar_spacer).setVisible(hasNavBar(getResources()));
        ...
        if (isLiteModeEnabled){
            navigationView.getMenu().findItem(R.id.nav_liteMode).setIcon(R.drawable.ic_checkbox_enabled);
        }else{
            navigationView.getMenu().findItem(R.id.nav_liteMode).setIcon(R.drawable.ic_checkbox_disabled);
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_numbers:
                loadURL("file:///android_asset/numbers/index.html");
                break;
            case R.id.nav_operations:
                loadURL("file:///android_asset/operations/index.html");
                break;
            case R.id.nav_geometry:
                loadURL("file:///android_asset/geometry/index.html");
                break;
            case R.id.nav_scales:
                loadURL("file:///android_asset/scales/index.html");
                break;
            case R.id.nav_graphs:
                loadURL("file:///android_asset/graphs/graphs.html");
                break;
            case R.id.nav_about:
            ...
            case R.id.nav_liteMode:
                ...
                editor.putBoolean("LiteModeEnabled",isLiteModeEnabled);
                editor.apply();
                setLiteMode(isLiteModeEnabled);
                break;
            default:
    ...
    private void setNightMode(boolean b){
        loadURL("javascript:setNightMode(" + b + ")");
    }
    private void setLiteMode(boolean b){
        loadURL("javascript:setLiteMode(" + b + ")");
        mainWebView.reload();
    }
}